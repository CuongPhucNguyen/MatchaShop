...
public class OrderRecyclerAdapter
        ...
        .Adapter<OrderRecyclerAdapter.ParentViewHolder> {
    ...
    public OrderRecyclerAdapter(List<OrderModel> itemList)
    {
            ...
            int position)
    {
        ...
        ProductRecyclerAdapter childItemAdapter
